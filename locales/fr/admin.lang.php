...
$GLOBALS['__l10n']['Theme configuration upgraded.'] = 'Configuration du thème mise à jour.';
...
$GLOBALS['__l10n']['To configure the top menu go to the <a href="%s">Simple Menu administration page</a>.'] = 'Pour configurer le menu allez à la <a href="%s">page d\'administration de l\'extension Menu Simple</a>.';
...
$GLOBALS['__l10n']['Search result entries'] = 'Billets résultants d\'une recherche';
...
$GLOBALS['__l10n']['Comment preview is not mandatory:'] = 'Prévisualisation du commentaire optionnelle :';
...
$GLOBALS['__l10n']['Font size (in em by default):'] = 'Taille de police (en em par défaut) :';
